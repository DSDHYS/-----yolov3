...
def convert_annotation(image_id, list_file):
    in_file = open('VOCdevkit/Annotations_test/%s.xml'%(image_id), encoding='utf-8')
...
for image_set in sets:
    image_ids = open('VOCdevkit/ImageSets_test/%s.txt'%(image_set),encoding='utf-8').read().strip().split()
