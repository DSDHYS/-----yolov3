...
yolo = mAP_Yolo()
image_ids = open('VOCdevkit/ImageSets_test/train_relative.txt').read().strip().split()#图片名称txt文档
...
for image_id in tqdm(image_ids):
    image_path = "./VOCdevkit/JPEGImages_test/"+image_id+".jpg"
    #image_path =image_id
