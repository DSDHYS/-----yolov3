...
from utils import (DecodeBox, letterbox_image,
...
class YOLO(object):
    _defaults = {
        "model_path"        : 'model_data/predict.pth',
    ...
    def _get_class(self):#从classes_path获得所有分类
    ...
    def detect_image(self,image):
        ...
        for i, c in enumerate(top_label):
            ...
            # cv2.putText(image,'A',(left,bottom),font,1,(0,255,0),3)
            # cv2.rectangle(frame,(left,bottom),(right,top),(0, 255, 0), 2)
            # font=cv2.FONT_HERSHEY_SIMPLEX#使用默认字体
            # frame=cv2.putText(frame,predicted_class,(left,top),font,1.2,(0,0,0),1)
