...
class DarkNet53(nn.Module):
    def __init__(self):
        ...
        self.contact_13_1=nn.Sequential(
            Conv2d_Block_5L(1280,512)
        )
        self.out_13=nn.Sequential(
            ConvolutionalLayer(512,1024,3,1,1),
            nn.Conv2d(1024,36,1,1,0)#33=(5+检测类数)*3
        )
        self.out_26=nn.Sequential(
            ConvolutionalLayer(256,512,3,1,1),
            nn.Conv2d(512,36,1,1,0)#33=(5+检测类数)*3
        )
        ...
        self.up_13=nn.Sequential(
            ...
            DownSampleLayer(64,128,1),
            DownSampleLayer(128,256,1)
            )#上采样,
    ...
    def forward(self,x):
        ...
        conval_13_1=self.contact_13_1(route_13)
        out_13 = self.out_13(conval_13_1)
...
# out_13,out_26,out_52 = model(img)
# print(out_13.shape)
# print(out_26.shape)
# print(out_52.shape)
