...
image_ids = open('VOCdevkit/ImageSets_test/train_relative.txt').read().strip().split()#图片打开路径
...
for image_id in image_ids:
    with open("./input/ground-truth/"+image_id+".txt", "w") as new_f:
        root = ET.parse("VOCdevkit/Annotations_test/"+image_id+".xml").getroot()#标签所在路径
