...
class ConvolutionalLayer(nn.Module):
    def __init__(self,in_channels,out_channels,kernal_size,stride,padding):
        ...
        self.conv1=nn.Sequential(
            nn.Conv2d(in_channels,out_channels,kernal_size,stride,padding, bias=False),#卷积
...
#             ConvolutionalLayer(13,52,3,1,1),
#             ConvolutionalLayer(52,36,3,1,1)#36为（5+种类数）*3
#         )
...
#             ConvolutionalLayer(26,13,3,1,1),
#             ConvolutionalLayer(13,36,3,1,1)#36为（5+种类数）*3
#         )
...
#             ConvolutionalLayer(128,26,3,1,1),
#             ConvolutionalLayer(26,36,3,1,1)#36为（5+种类数）*3
#         )
#         def forward(self,x):
#             out_1=self.out_1(x)
#             out_2=self.out_2(x)
